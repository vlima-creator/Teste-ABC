...
def get_svg_icon(name: str):
    icons = {
        ...
        "truck": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 17h4V5H2v12h3m15 0h2v-3.34a2 2 0 0 0-.73-1.5l-2.47-1.96a2 2 0 0 0-1.27-.45H14v7.25"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>',
...
def get_icon_name(emoji_or_name: str):
    """Mapeia emojis ou nomes para nomes de ícones SVG padronizados."""
    mapping = {
        "📦": "package",
        "💰": "dollar-sign",
        "📊": "bar-chart-3",
    ...
    return mapping.get(emoji_or_name, emoji_or_name)
